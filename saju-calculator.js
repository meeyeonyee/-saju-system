...
class SajuCalculator {
  constructor() {
    ...
    this.dayPillarInterpretations = {
      ...
      // 나머지 60갑자
      '갑술': { title: '갑술일주', description: '책임감이 강하고 신뢰받는 성격입니다. 조직을 잘 이끌며 사람들에게 안정감을 줍니다.', strength: '책임감, 신뢰성, 포용력', weakness: '고집, 변화 거부' },
      '을해': { title: '을해일주', description: '따뜻하고 지혜로운 성격입니다. 타인에 대한 이해심이 깊고 배려심이 많습니다.', strength: '이해심, 지혜, 포용력', weakness: '의존성, 우유부단' },
      '병자': { title: '병자일주', description: '총명하고 사교적인 성격입니다. 새로운 아이디어를 실현하는 능력이 뛰어납니다.', strength: '총명함, 사교성, 창의력', weakness: '산만함, 조급함' },
      '정축': { title: '정축일주', description: '차분하고 신중한 성격입니다. 꾸준히 노력하여 목표를 달성하는 끈기가 있습니다.', strength: '인내심, 성실함, 신중함', weakness: '완고함, 융통성 부족' },
      '무인': { title: '무인일주', description: '활동적이고 추진력이 강합니다. 새로운 도전을 즐기며 리더십이 있습니다.', strength: '추진력, 리더십, 용기', weakness: '성급함, 과욕' },
      '기묘': { title: '기묘일주', description: '섬세하고 예의 바릅니다. 조화를 중시하며 타인과의 관계를 잘 유지합니다.', strength: '섬세함, 조화, 예의', weakness: '소극적, 우유부단' },
      '경진': { title: '경진일주', description: '강인하고 결단력이 있습니다. 변화를 두려워하지 않고 혁신을 추구합니다.', strength: '결단력, 혁신성, 용기', weakness: '고집, 급진적' },
      '신사': { title: '신사일주', description: '지적이고 전략적입니다. 계획을 세워 체계적으로 일을 진행합니다.', strength: '지적, 전략적, 계획성', weakness: '비판적, 냉정함' },
      '임오': { title: '임오일주', description: '열정적이고 창의적입니다. 표현력이 뛰어나며 사람들을 잘 이끕니다.', strength: '열정, 창의력, 표현력', weakness: '감정적, 변덕' },
      '계미': { title: '계미일주', description: '온화하고 배려심이 깊습니다. 타인을 돕는 것에서 보람을 느낍니다.', strength: '배려심, 온화함, 봉사정신', weakness: '희생적, 자기주장 약함' },
      '갑신': { title: '갑신일주', description: '명석하고 판단력이 뛰어납니다. 논리적 사고와 실행력을 겸비했습니다.', strength: '명석함, 판단력, 실행력', weakness: '비판적, 고집' },
      '을유': { title: '을유일주', description: '섬세하고 완벽을 추구합니다. 미적 감각이 뛰어나고 디테일에 강합니다.', strength: '섬세함, 미적감각, 완벽추구', weakness: '까다로움, 비판적' },
      '병술': { title: '병술일주', description: '정직하고 정의로운 성격입니다. 사회적 책임을 중시하고 원칙을 지킵니다.', strength: '정직함, 정의감, 책임감', weakness: '융통성 부족, 고지식함' },
      '정해': { title: '정해일주', description: '지혜롭고 직관력이 뛰어납니다. 깊이 있는 사고와 통찰력을 가졌습니다.', strength: '지혜, 직관력, 통찰력', weakness: '망상적, 현실성 부족' },
      '무자': { title: '무자일주', description: '포용력이 크고 관대합니다. 사람들과의 조화를 중시하며 인맥이 넓습니다.', strength: '포용력, 관대함, 인맥', weakness: '우유부단, 타협적' },
      '기축': { title: '기축일주', description: '성실하고 근면합니다. 안정을 추구하며 신뢰할 수 있는 사람입니다.', strength: '성실함, 근면함, 신뢰성', weakness: '보수적, 융통성 부족' },
      '경인': { title: '경인일주', description: '용감하고 도전적입니다. 새로운 길을 개척하는 모험심이 있습니다.', strength: '용기, 도전정신, 개척력', weakness: '무모함, 조급함' },
      '신묘': { title: '신묘일주', description: '예술적 감각이 뛰어나고 세련되었습니다. 아름다움을 추구합니다.', strength: '예술성, 세련됨, 심미안', weakness: '이상적, 현실성 부족' },
      '임진': { title: '임진일주', description: '활동적이고 변화를 좋아합니다. 적응력이 뛰어나 다양한 환경에서 성공합니다.', strength: '활동성, 적응력, 유연성', weakness: '산만함, 일관성 부족' },
      '계사': { title: '계사일주', description: '지혜롭고 전략적입니다. 분석력이 뛰어나며 계획을 잘 세웁니다.', strength: '지혜, 전략성, 분석력', weakness: '계산적, 신중 과다' },
      '갑오': { title: '갑오일주', description: '열정적이고 적극적입니다. 밝은 에너지로 주변을 이끌어갑니다.', strength: '열정, 적극성, 리더십', weakness: '성급함, 감정적' },
      '을미': { title: '을미일주', description: '따뜻하고 포용력이 있습니다. 타인을 잘 배려하고 조화를 추구합니다.', strength: '포용력, 배려심, 조화', weakness: '우유부단, 자기주장 약함' },
      '병신': { title: '병신일주', description: '총명하고 재치있습니다. 빠른 판단력과 적응력을 가졌습니다.', strength: '총명함, 재치, 적응력', weakness: '산만함, 경솔함' },
      '정유': { title: '정유일주', description: '섬세하고 원칙적입니다. 높은 기준을 가지고 완벽을 추구합니다.', strength: '섬세함, 원칙성, 완벽추구', weakness: '까다로움, 융통성 부족' },
      '무술': { title: '무술일주', description: '책임감이 강하고 신뢰받습니다. 조직과 관리에 능합니다.', strength: '책임감, 신뢰성, 관리능력', weakness: '고집, 완고함' },
      '기해': { title: '기해일주', description: '지혜롭고 사려깊습니다. 타인의 입장을 잘 이해하고 공감합니다.', strength: '지혜, 공감능력, 이해심', weakness: '의존적, 우유부단' },
      '경자': { title: '경자일주', description: '명석하고 결단력이 있습니다. 논리적 사고와 판단력이 뛰어납니다.', strength: '명석함, 결단력, 논리성', weakness: '냉정함, 비판적' },
      '신축': { title: '신축일주', description: '성실하고 완벽주의 성향이 있습니다. 품질과 디테일을 중시합니다.', strength: '성실함, 완벽주의, 디테일', weakness: '까다로움, 스트레스' },
      '임인': { title: '임인일주', description: '활동적이고 적극적입니다. 새로운 도전을 즐기고 개척합니다.', strength: '활동성, 적극성, 개척력', weakness: '조급함, 과욕' },
      '계묘': { title: '계묘일주', description: '온화하고 예술적 감각이 있습니다. 세련되고 품위있는 성격입니다.', strength: '온화함, 예술성, 품위', weakness: '소극적, 이상적' },
      '갑진': { title: '갑진일주', description: '창의적이고 변화를 추구합니다. 혁신적 아이디어로 새로운 길을 엽니다.', strength: '창의력, 혁신성, 진취성', weakness: '급진적, 고집' },
      '을사': { title: '을사일주', description: '지적이고 전략적입니다. 분석력과 계획력이 뛰어납니다.', strength: '지적, 전략성, 분석력', weakness: '계산적, 냉정함' },
      '병오': { title: '병오일주', description: '열정적이고 창의적입니다. 강한 에너지와 표현력을 가졌습니다.', strength: '열정, 창의력, 표현력', weakness: '감정적, 독선적' },
      '정미': { title: '정미일주', description: '섬세하고 배려심이 깊습니다. 조화롭고 온화한 성격입니다.', strength: '섬세함, 배려심, 조화', weakness: '우유부단, 소극적' },
      '무신': { title: '무신일주', description: '판단력이 뛰어나고 실용적입니다. 논리적이고 효율적으로 일합니다.', strength: '판단력, 실용성, 효율성', weakness: '냉정함, 이기적' },
      '기유': { title: '기유일주', description: '완벽주의 성향이 있고 섬세합니다. 높은 기준과 품격을 추구합니다.', strength: '완벽주의, 섬세함, 품격', weakness: '까다로움, 비판적' },
      '경술': { title: '경술일주', description: '책임감이 강하고 정직합니다. 사회적 의무와 원칙을 중시합니다.', strength: '책임감, 정직함, 원칙성', weakness: '융통성 부족, 고지식함' },
      '신해': { title: '신해일주', description: '지혜롭고 직관력이 뛰어납니다. 깊은 사고와 통찰력을 가졌습니다.', strength: '지혜, 직관력, 통찰력', weakness: '이상적, 현실성 부족' },
      '임자': { title: '임자일주', description: '지적이고 유연합니다. 빠른 적응력과 학습능력을 가졌습니다.', strength: '지적, 유연성, 학습능력', weakness: '산만함, 일관성 부족' },
      '계축': { title: '계축일주', description: '성실하고 근면합니다. 꾸준히 노력하여 목표를 달성합니다.', strength: '성실함, 근면함, 끈기', weakness: '보수적, 완고함' },
      '갑인': { title: '갑인일주', description: '리더십이 강하고 용감합니다. 새로운 도전을 두려워하지 않습니다.', strength: '리더십, 용기, 도전정신', weakness: '고집, 독선적' },
      '을묘': { title: '을묘일주', description: '온화하고 예술적입니다. 아름다움과 조화를 추구합니다.', strength: '온화함, 예술성, 조화', weakness: '소극적, 우유부단' },
      '병진': { title: '병진일주', description: '활동적이고 열정적입니다. 변화와 도전을 즐깁니다.', strength: '활동성, 열정, 도전정신', weakness: '산만함, 조급함' },
      '정사': { title: '정사일주', description: '지적이고 신중합니다. 분석력과 전략적 사고가 뛰어납니다.', strength: '지적, 신중함, 전략성', weakness: '과도한 신중, 우유부단' },
      '무오': { title: '무오일주', description: '포용력이 크고 열정적입니다. 사람들과의 조화를 중시합니다.', strength: '포용력, 열정, 조화', weakness: '감정적, 의존적' },
      '기미': { title: '기미일주', description: '따뜻하고 배려심이 깊습니다. 타인을 돕는 것에 보람을 느낍니다.', strength: '배려심, 온화함, 봉사정신', weakness: '희생적, 자기주장 약함' },
      '경신': { title: '경신일주', description: '강인하고 명석합니다. 논리적이고 결단력있게 행동합니다.', strength: '강인함, 명석함, 결단력', weakness: '냉정함, 강압적' },
      '신유': { title: '신유일주', description: '완벽주의자이며 원칙적입니다. 높은 기준을 가지고 있습니다.', strength: '완벽주의, 원칙성, 정의감', weakness: '까다로움, 융통성 부족' },
      '임술': { title: '임술일주', description: '포용력이 있고 책임감이 강합니다. 사람들에게 신뢰를 받습니다.', strength: '포용력, 책임감, 신뢰성', weakness: '우유부단, 타협적' },
      '계해': { title: '계해일주', description: '지혜롭고 직관력이 뛰어납니다. 깊은 사고와 통찰력을 가졌습니다.', strength: '지혜, 직관력, 통찰력', weakness: '이상적, 망상적' },
      'default': { title: '일주 분석', description: '당신의 일주는 고유한 특성을 가지고 있습니다.', strength: '다양한 강점', weakness: '개선할 점' }
    };
  }
